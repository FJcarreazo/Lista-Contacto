...
const NUMBER_REGEX = /^[0]((424)|(426)|(414)|(412)|(416)|(212))[0-9]{7}$/;
...
list.addEventListener('click', e => {
  ...
  if (editBtn) {
    ...
    if (li.classList.contains('editando')) {  
       ...
       editValidation = REGEX_NAME.test(name.innerHTML);

       editNumberVAlidation = NUMBER_REGEX.test(phone.innerHTML);

       validateEditInput(name, editValidation)
       validateEditInput(phone, editNumberVAlidation)
      
      if (!editValidation || !editNumberVAlidation) return; {
